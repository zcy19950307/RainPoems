...
import com.rainpoems.rppms.service.SkuInfoService;
...
public class SkuInfoController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('rppms:skuinfo:list')")
    ...
    @PreAuthorize("hasAuthority('rppms:skuinfo:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('rppms:skuinfo:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('rppms:skuinfo:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('rppms:skuinfo:delete')")
