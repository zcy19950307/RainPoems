...
@Api(tags = "spu图片 管理")
@RestController
@RequestMapping("rppms/spuimages")
public class SpuImagesController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('rppms:spuimages:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('rppms:spuimages:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('rppms:spuimages:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('rppms:spuimages:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('rppms:spuimages:delete')")
