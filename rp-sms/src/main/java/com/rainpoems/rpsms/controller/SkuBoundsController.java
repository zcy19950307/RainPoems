...
import com.rainpoems.rpsms.service.SkuBoundsService;
...
@RestController
@RequestMapping("rpsms/skubounds")
public class SkuBoundsController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('rpsms:skubounds:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('rpsms:skubounds:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('rpsms:skubounds:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('rpsms:skubounds:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('rpsms:skubounds:delete')")
