...
import com.rainpoems.rpums.service.MemberLoginLogService;
...
@Api(tags = "会员登录记录 管理")
@RestController
@RequestMapping("rpums/memberloginlog")
public class MemberLoginLogController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('rpums:memberloginlog:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('rpums:memberloginlog:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('rpums:memberloginlog:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('rpums:memberloginlog:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('rpums:memberloginlog:delete')")
