...
@Api(tags = "会员统计信息 管理")
@RestController
@RequestMapping("rpums/memberstatisticsinfo")
public class MemberStatisticsInfoController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('rpums:memberstatisticsinfo:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('rpums:memberstatisticsinfo:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('rpums:memberstatisticsinfo:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('rpums:memberstatisticsinfo:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('rpums:memberstatisticsinfo:delete')")
